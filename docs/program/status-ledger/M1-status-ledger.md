...
| TASK-M1-011 | Bounded DAG Runner | TASK-M1-004, TASK-M1-007, TASK-M1-008, TASK-M1-010 | PG-M1-06 | IMPLEMENTED, TESTED | Implementation reconciled the stale BLOCKED row after all prerequisites were published and added the bounded local DAG runner with fixed concurrency, deterministic readiness execution, bounded routing/executor outcomes, and no provider/model/scheduler authority. |
