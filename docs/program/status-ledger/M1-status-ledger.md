...
| TASK-M1-005 | Capability Resolver Foundation | TASK-M1-001 | PG-M1-02A | IMPLEMENTED, TESTED | Implementation evidence records deterministic capability matching over frozen capability and agent-definition contracts. Independent validation/freeze is still required. |
